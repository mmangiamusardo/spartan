    ...
    public partial class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthManager.SignIn(properties, oAuthIdentity, cookieIdentity);
            }
            else
            {
        ...
        {
            IEnumerable<AuthenticationDescription> descriptions = AuthManager.GetExternalAuthenticationTypes();
