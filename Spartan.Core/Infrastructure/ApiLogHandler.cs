...
namespace Spartan.Core
{
    public class LoggerDelegatingHandler : DelegatingHandler
    {
            ...
            HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            MappedDiagnosticsLogicalContext.Set("requestid", guid.ToString());
            ...
            stopwatch.Stop();
            Log.Trace("Request completed. Duration:{0} StatusCode:{1}", (object)stopwatch.Elapsed, (object)response.StatusCode);
