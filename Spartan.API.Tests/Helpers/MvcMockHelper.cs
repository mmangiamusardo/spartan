...
namespace Spartan.Tests
{
    public class MvcMockHelper
    {
        ...
        public MvcMockHelper(ApiController controller)
        {
            ...
            //ControllerContext context = new HttpControllerContext(new RequestContext(HttpContext.Object, new RouteData()), controller);
